<?php
/**
 * ctci functions and definitions
 *
...
if ( ! function_exists( 'mytheme_setup' ) ) :
	...
	function mytheme_setup() {
		 ...
		 * If you're building a theme based on ctci, use a find and replace
		 * to change 'ctci' to the name of your theme in all the template files.
		 */
		//load_theme_textdomain( 'ctci', get_template_directory() . '/languages' );
...
function mytheme_widgets_init() {
	register_sidebar(
		array(
			...
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'ctci' ),
